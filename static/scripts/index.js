...
$(document).ready(function(){
    ...
    $(".advertisement-image-putting").on('click', function () {
        ...
        image_full_display = `<img class="d-block w-100" height=300px src="./static/style/img/temp/`+new_actual_advertisement[list_index]["photo"]+`">`
...
function displayAdsLatest(advertisement_putting, counter, capable, counterNeed){
    ...
    for(var i = 4*(counter-1); i< display; i++){
        ...
        document.getElementById(images_loading_class).style.backgroundImage="url('./static/style/img/temp/"+advertisement_putting[i]["photo"]+"')";
    }
    return counter;
}
function displayAds(new_actual_advertisement, counter, capable, counterNeed){
    ...
    for(var i = 4*(counter-1); i< display; i++){
        ...
        document.getElementById(images_loading_class).style.backgroundImage="url('./static/style/img/temp/"+new_actual_advertisement[index]["photo"]+"')";
    }
    return counter;
